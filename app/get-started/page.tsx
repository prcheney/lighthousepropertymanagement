...
export default function GetStarted() {
  return (
    <main>
      ...
      <Testimonials />
      <FAQ ctaText="Talk to a local expert" subtitle="Still have questions? Call us directly or fill out the form below and we'll reach out within one business day." items={getStartedFaqs} />
      <AdsContactForm />
      <Footer />
    </main>
  );
